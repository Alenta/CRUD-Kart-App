...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        app.UseDefaultFiles();
        app.UseStaticFiles();
        //app.UseHttpsRedirection(); <-- Gives warning for now. Needed? *Automatically redirect HTTP requests to HTTPS*
        app.UseRouting(); // Responsible for routing incoming requests to the appropriate endpoint based on the request's path and HTTP method
        ...
        app.MapGet("/geocode", async (string address, IHttpClientFactory httpClientFactory) =>
        {
            ...
            var apiKey = "AIzaSyBS7Yyd9cTfgh4Tee84AvjJBm-E2gmnfyE"; //The api key
        ...
        app.Run(); //! Must be at the bottom to be able to read app functions
    }
}